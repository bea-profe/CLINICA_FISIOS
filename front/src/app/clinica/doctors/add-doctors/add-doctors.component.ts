...
public hours_selecteds:any=[];
  ...
  save(){
   ...
   if(!this.name || !this.email || !this.surname || !this.avatar || !this.password|| !this.movil|| !this.specialitie_id|| !this.roles){
     this.text_validation = "Los siguientes campos son necesarios (apellido, nombre, password, movil, role, especialidad y avatar)";
     return;
   }
